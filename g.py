...
query = [ 
  {
    ...
    "query_class": utils.query.Query,
    "evaluation_class": utils.evaluation.Evaluation,
    "cnt": 150,
    "qf_parts": ['title'],
  ...
  }, 
  {
    ...
    "query_class": utils.query.ClueWebQuery,
    "evaluation_class": utils.evaluation.EvaluationClueWeb,
    "cnt": 200,
    "qf_parts": ['title'],
